                        ...
                        <Col style={styles.map} sm="12" md={{ size: 12, offset: 0 }}>
                            ...
                            <Row style={styles.marginBottom}>
                                <Col  sm={{ size: 2, order: 2, offset: 10 }}>
                                    <Button style={styles.w_100} onClick={this.query} outline color="primary">Rechercher</Button>
                                </Col>
                            </Row>
                            ...
                            <Map
                                ...
                                {this.state.selected !== null ?
                                    <Card style={styles.cardMap}>
                                        <CardHeader onClick={null} style={styles.cardHeader}>{this.state.selected.nom}</CardHeader>
                                        <CardBody>
                                        <ListGroup flush>
                                            {Object.keys(this.state.selected).map((key,i)=>{
                                                if(!Number.isInteger(parseInt(key)) &&
                                                    ...
                                                    if(key.match(/^(site_web)$/)){
                                                        return (
                                                            <ListGroupItem tag="a" target="_blank" href={"http://"+this.state.selected[key]}>
                                                                <FontAwesomeIcon style={styles.icon_left} icon={this.icon(key)}/>
                                                                <p style={styles.inline}>
                                                                    {key} : {this.state.selected[key]}</p></ListGroupItem>
                                                        );
                                                    }else{
                                                        return (
                                                            <ListGroupItem tag="p" > <FontAwesomeIcon style={styles.icon_left} icon={this.icon(key)}/> <p style={styles.inline}> {this.state.selected[key]}</p></ListGroupItem>
                                                        );
                                                    }
                                                }
                                            })}
                                ...
                                return (
                                    <Col xs="6" sm="3">
                                        <Card style={styles.cardItem}>
                                            <CardHeader onClick={()=>this.flyTo(marker)} style={styles.cardHeader}>{marker.nom}</CardHeader>
                                            <CardBody>
