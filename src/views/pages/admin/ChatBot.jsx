                ...
                <Container className={'container'}>
                    <Row>
                        <Col xs="12">
                            <Card className={'card'}>
                                <CardBody>
                                    <CardTitle style={{width:'auto',fontWeight:'bold', color:'#000',display:'inline-block'}} className={'titre'}>Questions</CardTitle>
                                    <FontAwesomeIcon style={{display:'inline-block',float:'right'}} color={"#000"} icon={faSave}/>
