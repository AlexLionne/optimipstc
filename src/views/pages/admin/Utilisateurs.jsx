                ...
                <Container className={'container'}>
                    <Row>
                        <Col sm={'6'} xs={'12'}>
                            <Card className={'card'}>
                                <CardBody>
                                    <CardTitle style={{width:'auto',fontWeight:'bold', color:'#000',display:'inline-block'}} className={'titre'}>{structures_non_valides.length} Sructures non liées </CardTitle>
                                        ...
                                        <ListGroup flush>
                                            {
                                                structures_non_valides.map((structure,i)=>{
                                                    return(
                                                        <ListGroupItem  className={'link_primary'} href="#">{structure.nom}</ListGroupItem>
                                                    )
                                                })}
                                        </ListGroup>
                                    </CardText>
                        ...
                        <Col sm={'6'} xs={'12'}>
                            <Card className={'card'}>
                                <CardBody>
                                    <CardTitle style={{width:'auto',fontWeight:'bold', color:'#000',display:'inline-block'}} className={'titre'}>{utilisateurs.length} Utilisateurs</CardTitle>
                                        ...
                                        <ListGroup flush>
                                            {
                                                utilisateurs.map((utilisateur,i)=>{
                                                    return(
                                                        <ListGroupItem  className={'link_primary'} href="#">{utilisateur.mail}</ListGroupItem>
                                                    )
                                                })}
                                        </ListGroup>
                                    </CardText>
