                                    ...
                                    { (()=> {
                                        if (reactLocalStorage.get('super_admin') === 'true') {
                                            ...
                                            return ( <Nav className="mr-auto" navbar >
                                                <NavItem>
                                                    <NavLink className={this.state.activeItem === 1 ? 'nav_link_active' : 'nav_link'} href="/admin/structures" >Gestion des centres</NavLink>
                                                </NavItem>
                                                <NavItem>
                                                    <NavLink className={this.state.activeItem === 2 ? 'nav_link_active' : 'nav_link'} href="/admin/parametres" >Paramètres du compte</NavLink>
                                                </NavItem>
                                            </Nav>)
                                        }
                                    })()
