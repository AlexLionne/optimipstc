                ...
                <Container fluid className={'container-justify'}>
                    <Row>
                        <Col xs="9">
                            ...
                            <ul>
                                <li><a onClick={this.triggerModalScanner} href={"#"} className={'link'}>transfert vers un service d'Urgence avec scanner accessible.</a></li>
                                <li> consultation chez le généraliste ou aux urgences.</li>
                                <li><a onClick={this.triggerModalSD} href={"#"} className={'link'}>surveillance à domicile.</a></li>
                            </ul>
                            <p>
