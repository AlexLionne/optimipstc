            ...
            <section className={'section'}>
                    ...
                    <Row className={'justify-content-start'}>
                                ...
                                <CardBody>
                                    <Card className={'container-set-bis reposition text-center'}>
                                        ...
                                        <CardBody className={'TCL-interface'}>
                                            ...
                                            <a onClick={this.triggerModalAM} href={"#"} className={'link'}> Aide ménagère </a><br/>
                                    ...
                                    <Card className={'container-set-bis reposition text-center'}>
                                        ...
                                        <CardBody className={"TCL-interface"}>
                                            <a onClick={this.triggerModalSAMSAH} href={"#"} className={'link'}> SAMSAH </a><br/>
                                            <a onClick={this.triggerModalSAVS} href={"#"} className={'link'}> SAVS </a><br/>
                                            <a onClick={this.triggerModalSSIAD} href={"#"} className={'link'}> SSIAD </a><br/>
                                            <a onClick={this.triggerModalSAAD} href={"#"} className={'link'}> SAAD </a><br/>
                                        </CardBody>
                                    </Card>
                                    <Card className={'container-set-bis reposition text-center'}>
                                        <CardTitle className={'titre'}>
                        ...
                        <Col xs="6" xl="4">
                            ...
                            <Card>
                                ...
                                <CardBody className={'TCL-interface'}>
                                            <a onClick={this.triggerModalMTra} href={"#"} className={'link'}>Médecine du travail </a><br/>
                                            <a onClick={this.triggerModalAdapt} href={"#"} className={'link'}> Adaptation de poste </a><br/>
                                            <a onClick={this.triggerModalESAT} href={"#"} className={'link'}> Atelier protégé ESAT </a><br/><br/>
                                    <Card>
                                        <CardTitle className={'titre'}>
                                            Services d'accompagnement
                                        </CardTitle>
                                        <CardBody className={'TCL-interface'}>
                                            <a onClick={this.triggerModalUEROS} href={"#"} className={'link'}> UEROS </a><br/>
                                            <a onClick={this.triggerModalCOMETE} href={"#"} className={'link'}> COMETE </a><br/>
                                            <a onClick={this.triggerModalCAPE} href={"#"} className={'link'}> CAP EMPLOI </a><br/>
                                            <a onClick={this.triggerModalSMMETH} href={"#"} className={'link'}> SAMETH </a><br/>
                ...
                <Modal className={'tc_modal'} isOpen={this.state.modalAM} fade={false} centered>
                    ...
                    <ModalBody>
                        ...
                        Prise en charge : varie selon la situation : aide financière départementale ou caisse de retraite ou la mutuelle.<br/>
                    </ModalBody>
                    <ModalFooter>
                ...
                <Modal className={'tc_modal'} isOpen={this.state.modalSAVS} fade={false} centered>
                    ...
                    <ModalBody>
                        ...
                        Il apporte des conseils et aides pratiques pour tout ce qui concerne la vie courante, l'alimentation, les démarches administratives, le logement, le travail, les loisirs, la gestion budgétaire, etc.<br/>
                    </ModalBody>
                    <ModalFooter>
                ...
                <Modal className={'tc_modal'} isOpen={this.state.modalSAMSAH} fade={false} centered>
                    ...
                    <ModalBody>
                        ...
                        Comment : la demande de « notification SAMSAH » est faite sur le certificat de la MDPH rempli par le médecin. La commission de la MDPH prendra la décision.<br/>
                        Prise en charge : Assurance Maladie pour la partie soins, Conseil Général pour la partie accompagnement<br/>
                    </ModalBody>
                    <ModalFooter>
                ...
                <Modal className={'tc_modal'} isOpen={this.state.modalSSIAD} fade={false} centered>
                    ...
                    <ModalBody>
                        S’occupe de trouver les intervenants nécessaires pour assurer les actes infirmiers et les aides aux soins d’hygiène nécessaires à la personne.<br/>
                ...
                <Modal className={'tc_modal'} isOpen={this.state.modalGEM} fade={false} centered>
                    ...
                    <ModalBody>
                        Lieu ouvert aux personnes cérébrolésées, encadré par des animateurs et des bénévoles et financé par l’Agence Régionale de Santé. C’est un lieu de rencontres, d’échanges, d’entraide et de loisirs partagés.
                    </ModalBody>
                    <ModalFooter>
                ...
                <Modal className={'tc_modal'} isOpen={this.state.modalYMCA} fade={false} centered>
                    ...
                    <ModalBody>
                        Unité de Soutien et d'Accompagnement aux Personnes Cérébrolésées. Association régionale qui gère des établissements sociaux et médico-sociaux agréés, notamment un ESAT, une entreprise adaptée, un centre de rééducation professionnelle, et des foyers d’hébergement. Elle accueille également des personnes cérébro lésées pour des activités rééducatives (individuelles ou collectives).<br/>
                        Pour qui : personne en situation de handicap<br/>
                        Comment : il faut demander une notification d’orientation sur le certificat MDPH rempli par le médecin.<br/>
                    </ModalBody>
                    <ModalFooter>
                ...
                <Modal className={'tc_modal'} isOpen={this.state.modalAdapt} fade={false} centered>
                    ...
                    <ModalBody>
                        Le salarié peut demander à bénéficier d’adaptations des conditions de travail à son état de santé. Il peut s’agir d’adaptation des horaires (pour permettre une sieste en cas de fatigabilité par exemple), de télétravail, d’aménagement technique (rampe d’accès, bureau adapté par exemple). Cela doit être discuté avec l’employeur et le médecin du travail ; un certificat médical justifiant l’état de santé peut être demandé.<br/>
                        L’entreprise peut obtenir des aides financières via l’Agefiph pour réaliser les aménagements ou acheter du matériel adapté.<br/>
                ...
                <Modal className={'tc_modal'} isOpen={this.state.modalESAT} fade={false} centered>
                    ...
                    <ModalBody>
                        Il s’agit de structures qui permettent aux personnes en situation de handicap grave de réaliser leur activité professionnelle en bénéficiant d'un soutien médico-social et éducatif dans un milieu protégé. Les travailleurs sont rémunérés entre 55 % et 110 % du SMIC. Il y a souvent un foyer d’hébergement associé à la structure.<br/>
                        Pour qui : personne qui ne peut pas travailler dans une entreprise ordinaire ou une entreprise adaptée. Car la capacité de travail ne dépasse pas le 1/3 de celle d'une personne valide, ou si la personne a besoin de soutiens médicaux, éducatifs, sociaux et psychologiques. Il faut avoir au moins 20 ans.<br/>
                        Comment : la demande de « notification RQTH avec orientation vers un Esat » est faite sur le certificat de la MDPH rempli par le médecin. La commission de la MDPH (CDAPH) prendra la décision.<br/>
                    </ModalBody>
                    <ModalFooter>
                ...
                <Modal className={'tc_modal'} isOpen={this.state.modalUEROS} fade={false} centered>
                    <ModalHeader >Unité d'Evaluation, de Réentrainemenet de d'Orientation Socioprofessionnelle</ModalHeader>
                    <ModalBody>
                        Une équipe pluri disciplinaire (médecin, ergothérapeute, psychologue / neuropsychologue, chargé d’insertion, formateur, assistant de service social, secrétaire) va étudier les possibilités de réinsertion sociale et/ou professionnelle.  L’objectif est d’élaborer et de mettre en œuvre un programme de réentrainement individualisé pour optimiser ses capacités et de construire un projet d’insertion.<br/>
                        Pour qui : adultes de 18 à 60 ans en situation de handicap suite à une lésion cérébrale acquise, avec notification RQTH (Reconnaissance de la qualité de travailleur handicapé : cf en bas).<br/>
                        Comment : la demande de « notification UEROS » est faite sur le certificat de la MDPH rempli par le médecin. La commission de la MDPH prendra la décision.<br/>
                        Et les propositions d’orientation après l’évaluation de l’UEROS doivent aussi être validées par la MDPH.<br/>
                    </ModalBody>
                    <ModalFooter>
                ...
                <Modal className={'tc_modal'} isOpen={this.state.modalCOMETE} fade={false} centered>
                    ...
                    <ModalBody>
                        Association présente dans certains services de Médecine Physique et de Réadaptation. Avec les compétences d’une équipe pluri disciplinaire l’objectif est la prise en charge précoce des problématiques socio-professionnelles des patients hospitalisés.<br/>
                ...
                <Modal className={'tc_modal'} isOpen={this.state.modalCAPE} fade={false} centered>
                    ...
                    <ModalBody>
                        Organisme du service public qui accueille, informe et conseille la personne en situation de handicap et les entreprises en vue d’une insertion professionnelle, d’une transition professionnelle ou d’une formation ; en milieu ordinaire de travail.<br/>
                        Pour qui : les entreprises et les personnes reconnues travailleur handicapé (RQTH) par la MDPH<br/>
                ...
                <Modal className={'tc_modal'} isOpen={this.state.modalSMMETH} fade={false} centered>
                    ...
                    <ModalBody>
                        Son objectif est d’aider les salariés et les entreprises à trouver une solution de maintien dans l’emploi quand celui n’est pas possible dans les conditions actuelles en raison du handicap du salarié. Il peut alors proposer des aménagements matériels, de temps de travail, demander des aides financières.<br/>
                ...
                <Modal className={'tc_modal'} isOpen={this.state.modalMAS} fade={false} centered>
                    ...
                    <ModalBody>
                        Structure d’hébergement qui accueille des adultes avec handicap grave et dont les capacités de décision et d'action dans les actes de la vie quotidienne sont altérées. On y propose des activités d'éveil ou occupationnelles,  des soins médicaux et paramédicaux adaptés<br/>
                        Pour qui : adulte nécessitant le recours à une tierce personne pour les actes de la vie courante ainsi qu'une surveillance médicale et des soins constants.<br/>
                        Comment : demande MDPH via le formulaire spécifique<br/>
                        Prise en charge : Sécurité sociale + participation financière du résident de 20 € par jour (sauf si CMU-complémentaire)<br/>
                    </ModalBody>
                    <ModalFooter>
                ...
                <Modal className={'tc_modal'} isOpen={this.state.modalFAM} fade={false} centered>
                    ...
                    <ModalBody>
                        Structure d'hébergement qui accueille des adultes avec handicap grave. Elle permet un accompagnement pour effectuer les actes essentiels de la vie courante, une aide éducative, des soins médicaux et paramédicaux adaptés.<br/>
                        Pour qui : adulte nécessitant le recours à une tierce personne pour les actes de la vie courante ainsi qu'une surveillance médicale et des soins constants.<br/>
                        En principe, le foyer d'accueil médicalisé (Fam) accueille des personnes un peu moins dépendantes que celles hébergées en maison d'accueil spécialisée (Mas), mais dans la pratique, les publics sont sensiblement les mêmes.<br/>
                        Comment : demande MDPH via le formulaire spécifique<br/>
                        Prise en charge : Sécurité Sociale + participation aux frais d'hébergement et d'entretien demandée au résident, plafonnée en fonction des revenus.<br/>
                    </ModalBody>
                    <ModalFooter>
                ...
                <Modal className={'tc_modal'} isOpen={this.state.modalFoyer} fade={false} centered>
                    ...
                    <ModalBody>
                        Etablissement qui accueille des adultes handicapés ayant une certaine autonomie pour leur proposer des animations, des activités ludiques et éducatives en fonction de leur handicap. Il peut s’agir d’un accueil temporaire, de jour ou en internat.<br/>
                        Pour qui : adultes avec taux d'incapacité d'au moins 50 % et ne relevant ni d'un établissement et service d'aide par le travail (Ésat), ni d'une maison d'accueil spécialisée (Mas), ni d'un foyer d'accueil médicalisé (Fam).<br/>
                        Comment : demande MDPH via le formulaire spécifique<br/>
                        Prise en charge : Sécurité Sociale + participation aux frais d'hébergement et d'entretien demandée au résident, plafonnée en fonction des revenus.<br/>
                    </ModalBody>
                    <ModalFooter>
