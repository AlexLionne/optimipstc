                    ...
                    <Row className={'row-top'}>
                        <Col xs="6"  className={'testtt'}>
                                ...
                                <p>
                                    ...
                                    Ce site internet présente le réseau Traumatisme Crânien d'Occitanie, ses actualités et vous oriente vers des outils, une cartographie des structures de la région prenant en charge les personnes ayant subies un traumatisme crânien et des documents ressources.<br/>
                                    Bonne visite<br/>
                                </p>
                        </Col>
                    </Row>
