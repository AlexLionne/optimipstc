                                                        ...
                                                        if(column.name === 'text'){
                                                            return  <Col xs={'11'}  id={column.id} onClick={(e) => {
                                                                ...
                                                                {this.state.selectedElement === column.id &&  this.state.superAdmin === 'true'?
                                                                    ...
                                                                    : null}
                                                                <EditView readOnly={this.state.superAdmin === 'true'} id={column.id} html={column.html} ref={this._items.ref(column.id)} onChange={this.handleEditorChange}/>
                                                            </Col>
                                                        }
                                                        else{
                                        ...
                                        <Row>
                                            <Col xs={'12'}>
                                                <FormGroup check inline>
                                                    <Label check>
                                                       <Input type="checkbox" onChange={this.handleInNav} /> Intégrer la page dans la barre de navigation
                                                    </Label>
                                                </FormGroup>
                                            </Col>
                                        </Row>
